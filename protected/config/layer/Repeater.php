				...
				<div id=\"tabs-1\">
					<ul>
					 <li><FONT COLOR=#0000cc>Site ID:<FONT COLOR=#000000\>" . $attributes["key"] . "</li>
					  <li><FONT COLOR=#0000cc>Switch ID/ RNC Manager Name:<FONT COLOR=#000000\>" . $attributes["switch_id"] . "</li>
					  <li><FONT COLOR=#0000cc>Vendor:<FONT COLOR=#000000\>" . $attributes["vendor"] . "</li>
					  <li><FONT COLOR=#0000cc>Donor Site :<FONT COLOR=#000000\>" . $attributes["donor_site_id"] . "</li>
					  <li><FONT COLOR=#0000cc>Donor Sector:<FONT COLOR=#000000\>" . $attributes["donor_sector"] . "</li>
