...
//
// Geo Module For Custom Mapping
//
$route['get']['/wms'] = array('WMSController', 'wms');
$route['get']['/wms/pie/:cluster_zoom_level'] = array('WMSPieController', 'wms');

$route['get']['/kml/site/cluster/:layer/:style/:cluster_zoom_level'] = array('KMLController', 'siteCluster');
$route['get']['/kml/site/icon/:color/:size'] = array('KMLController', 'siteIcon');

$route['get']['/search/:layer'] = array('SearchController', 'index');
$route['get']['/grid/:layer'] = array('GridController', 'index');

$route['get']['/search'] = array('SearchController', 'nearest_cells');
//User Controller
//$route['post']['/user/setclusterzoomlevel'] = array('UserController', 'setClusterZoomLevel');


//Utils
$route['*']['/utility/cluster/:group/:layer'] = array('UtilityController', 'cluster');
$route['*']['/utility/cell/:group/:layer'] = array('UtilityController', 'cell');

$route['post']['/query'] = array('SQLController', 'query') ; 
// Default Error Route
$route['*']['/error'] = array('ErrorController', 'index');

//Legend Controller
$route['*']['/legend'] = array('LegendController', 'getLegend');
