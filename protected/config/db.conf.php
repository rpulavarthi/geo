...
//Postgis [Geo Mapping]
$dbconfig['dev'] = array('138.85.245.145', 'emap', 'gis', 'gis', 'pgsql', true, 'gis_schema');
//$dbconfig['dev'] = array('localhost', 'emap;port=54321;', 'rftech', '', 'pgsql', true, 'public');


//Mysql [User profile and layer config]
//$dbconfig['dev_mysql'] = array('localhost', 'emap', 'root', '', 'mysql', true);
 //$dbconfig['dev'] = array('10.242.242.35', 'emap', 'dashboard', 'dashboard', 'pgsql', true, 'public');
?>
